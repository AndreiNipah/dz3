package com.example.dz3.ui.screen.country
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = onOpenQuiz) {
                        Icon(Icons.Outlined.Quiz, contentDescription = "Quiz")
                    }
                    IconButton(onClick = onOpenQuizHistory) {
                        Icon(Icons.Outlined.Assessment, contentDescription = "Quiz progress")
                    }
